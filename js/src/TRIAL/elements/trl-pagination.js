 ...
 */
(function (window) {
    window.T.elements.custom(window.T.elements.TRL_PAGINATION, {
        prototype: Object.create(HTMLDivElement.prototype, {
            ...
            fetch: {
                value: function () {
                    this.loading = false;
                    var current_page_offset = this.currentPageOffset;
                    ...
                    if (data !== null) {
                        ...
                        for (var i = 0; i < length; i++)
                            this.dispatchEvent(new CustomEvent("fetchdata", {
                                detail: {
                                    page: {
                ...
                value: function () {
                    ...
                    for (var i = 0; i < num_pages; i++) {
                        ...
                        page_btn.onclick = function (i, pages, btn) {
                            ...
                            try {
                                pages.getElementsByClassName("trl-pagination__selected")[0].classList.remove("trl-pagination__selected");
                            } catch (e) {}
    ...
    window.dispatchEvent(new CustomEvent("T.elements.Pagination-Ready"));
})(window);