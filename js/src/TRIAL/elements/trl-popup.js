...
(function (window) {
    window.T.elements.custom(window.T.elements.TRL_POPUP, {
        prototype: Object.create(HTMLDivElement.prototype, {
            ...
            /* created on 19/06/2017 01:39:27
            setBackground: {
                value: function (background) {
                    var is_dom = window.T.Utils.isElement(background) || window.T.Utils.isNode(background), is_selector = typeof background === "string";
                    if (!is_dom && !is_selector)
                        throw new TypeError("trl-popup background must be a HTMLElement instance");
                    this.__bg = is_selector ? this.querySelector(background) : background;
                    this.appendChild(this.__bg);
                }
            },
            // created on 19/06/2017 01:40:17
            getBackground: {
                value: function () {
                    if (!this.__bg)
            ...
            // created on 19/06/2017 01:27:11
            setContent: {
                value: function (content) {
                    var is_dom = window.T.Utils.isElement(content) || window.T.Utils.isNode(content), is_selector = typeof content === "string";
                    if (!is_dom && !is_selector)
                        throw new TypeError("trl-popup content must be a HTMLElement instance");
                    this.__content = is_selector ? this.querySelector(content) : content;
                    this.appendChild(this.__content);
                }
            },
            // created on 19/06/2017 01:27:33
            getContent: {
                value: function () {
                    if (!this.__content)
            ...
            // created on 22/06/2017 21:37:11
            getBackground: {
                value: function () {
                    if (!this.__bg)
            ...
            // created on 25/06/2017 01:23:36
            background: {
                get: function () {
                    if (!this.__bg)
            ...
            // created on 25/06/2017 01:34:05
            getContent: {
                value: function () {
                    if (!this.__content)
            ...
            // created on 25/06/2017 01:34:18
            content: {
                get: function () {
                    if (!this.__content)
            ...
            // created on 19/06/2017 01:44:13
            // renamed setOutsideClick() to outside_click on 24/06/2017 19:27:41
            outside_click: {
                set: function (b) {
                    if (typeof b !== "boolean")
            ...
            // created on 19/06/2017 01:44:53
            // removed getOutsideClick() on 24/06/2017, 19:25:51
            
            // created on 19/06/2017 01:53:50
            // renamed setAutoDismiss() to autodismiss on 24/06/2017 19:25:25
            autodismiss: {
                set: function (b) {
                    if (typeof b !== "boolean")
            ...
            // created on 19/06/2017 01:44:53
            // removed getAutoDismiss() on 24/06/2017, 19:25:33
            
            // created on 19/06/2017 01:56:55
            setAlignment: {
                value: function (a) {
            ...
            // created on 19/06/2017 02:04:38
            // renamed setFreezePage to freeze on 24/06/2017 19:23:49
            freeze: {
                set: function (b) {
                    if (typeof b !== "boolean")
            ...
            // created on 19/06/2017 02:04:38
            // removed freeze on 24/06/2017, 19:23:50
            
            // created on 19/06/2017 11:16:22
            setController: {
            ...
            // created on 24/06/2017 19:43:06
            width: {
                set: function (n) {
                    if (typeof n !== "string")
            ...
            // created on 06/03/2018 22:39:11
            fluid: {
                set: function (b) {
                    if (typeof b !== "boolean")
            ...
            // created on 24/06/2017 19:59:06
            keep: {
                set: function (b) {
                    if (typeof b !== "boolean")
            ...
            // created on 26/06/2017, 22:39:59
            isOpen: {
                value: function () {
                    return this.opened;
                }
